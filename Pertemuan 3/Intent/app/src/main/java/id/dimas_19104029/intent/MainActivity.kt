...
import id.dimas_19104029.intent.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            btnProdi.setOnClickListener {
                ...
                val moveWithDataIntent = Intent(this@MainActivity, IntentReadDataActivity::class.java)
                moveWithDataIntent.putExtra(IntentReadDataActivity.EXTRA_PRODI, namaProdi)
